...
public class CommandBuilder {
    ...
    /**
     * Constructs the commandline to be used for launching weblogic.Deployer to
     * deploy an app.
     * 
     * @return A {@link List} of {@link String} that contains the commandline to
     *         be used to launch weblogic.Deployer for deploying an app.
     */
    public List<String> buildDeployCommand() {
        List<String> cmd = new ArrayList<String>();
        // Use the same Java Home as the one used by Arquillian to launch
        // weblogic.Deployer.
        // This will avoid confusion over the cacerts file if used as the SSL
        // Trust Store.
     ...
     * 
     * @return A {@link List} of {@link String} that contains the commandline to
     *         be used to launch weblogic.Deployer for undeploying an app.
     */
