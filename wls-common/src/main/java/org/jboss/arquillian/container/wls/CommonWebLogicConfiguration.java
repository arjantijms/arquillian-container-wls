...
public class CommonWebLogicConfiguration implements ContainerConfiguration {
    ...
    public void validate() throws ConfigurationException {
        ...
        if (wlsHome != null && wlsHome.length() > 0) {
            Validate.directoryExists(wlsHome, "The wlsHome directory resolved to " + wlsHome
        ...
        Validate.directoryExists(wlHome, "The wlHome directory resolved to " + wlHome
                + " and could not be located. Verify the property in arquillian.xml");
        ...
        // Once validated, set the properties that can be derived, if not
        // already set.
        try {
            ...
            Validate.isInList(adminProtocol, new String[] { "t3", "t3s", "http", "https", "iiop", "iiops" },
        ...
        Boolean[] trustTypes = new Boolean[] { useDemoTrust, useCustomTrust, useJavaStandardTrust };
        ...
        if (useCustomTrust) {
            Validate.isValidFile(
                    trustStoreLocation,
                    "The trustStoreLocation file was resolved to "
                            + trustStoreLocation
        ...
        if (useJavaStandardTrust) {
            ...
            Validate.isValidFile(trustStoreLocation, "The trustStoreLocation file was resolved to "
                    + trustStoreLocation
        ...
        Validate.isValidFile(weblogicJarPath,
        ...
        Validate.notNullOrEmpty(jmxProtocol,
                "The jmxProtocol is empty. Verify the adminUrl, adminProtocol and jmxProtocol properties in arquillian.xml");
        Validate.isInList(jmxProtocol, new String[] { "t3", "t3s", "http", "https", "iiop", "iiops" },
    ...
    /**
     * @param adminProtocol Protocol to use to connect to AdminServer. This is
     *            optional. It can be derived from the adminUrl.
     */
    ...
    /**
     * @param adminListenAddress The listen address of the admin server. This is
     *            optional. It can be derived from the adminUrl.
     */
    ...
    /**
     * @param adminListenPort The port of the admin server. This is optional. It
     *            can be derived from the adminUrl.
     */
     ...
     * 
     * @param wlsHome The location of the local WebLogic Server installation.
     *            The parent directory of this location is usually named
     *            wlserver_x.y. The directory must also contain the 'common' and
    ...
    /**
     * 
     * @param wlHome The location of the local WebLogic Server installation. The
     *            parent directory of this location is usually named
     *            wlserver_x.y. The directory must also contain the 'common' and
     *            'server' subdirectories. Defaults to the value of the WL_HOME
    ...
    /**
     * @param target The name of the target for the deployment. This can be the
    ...
    /**
     * @param jmxClientJarPath The location of wljmxclient.jar or an equivalent
     *            library. (optional)
     */
    ...
    /**
     * @param jmxProtocol The protocol to use, when connecting to the WebLogic
     *            Domain Runtime MBean Server. (optional)
     */
    ...
    /**
     * @param jmxHost The host where the WebLogic Domain Runtime MBean Server
     *            resides. (optional)
     */
    ...
    /**
     * @param jmxPort The port that the WebLogic Domain Runtime MBean Server
     *            listens on. (optional)
     */
    ...
    /**
     * @param useDemoTrust Use the Demo Truststore, to connect to a WebLogic
     *            Server that uses Demo Identity and Trust stores.
     */
    ...
    /**
     * @param useCustomTrust Use a custom Truststore, to connect to a WebLogic
     *            Server that uses a Custom Trust store.
     */
    ...
    /**
     * @param useJavaStandardTrust Use a the Truststore of the running JRE, to
     *            connect to a WebLogic Server that uses the Java Standard Trust
     *            store.
     */
    ...
    /**
     * @param trustStoreLocation The location of the truststore. This should be
     *            specified when using a custom trust store. This is computed
     *            internally, when using the Java Standard Trust or the Demo
     *            Trust store.
     */
    ...
    /**
     * @param ignoreHostNameVerification Specifies whether hostname verification
     *            should be enabled or disabled for the weblogic.Deployer
     *            process.
     */
    ...
    /**
     * @param hostnameVerifierClass The fully qualified class name of the
     *            hostname verifier class
     */
    ...
    /**
     * @param classPath The classpath entries that will be added to the
     *            classpath used by weblogic.Deployer. The location of the
    ...
    /**
     * 
     * @param useURandom Enables the use of /dev/urandom as the entropy
     *            gathering device for the JVM used to launch weblogic.Deployer.
     *            To be used in Linux/Unix.
     */
    ...
    /**
     * @param deployExplodedArchive Specifies whether to deploy explode WAR
     *            before deploying, or not (default = false).
     */
